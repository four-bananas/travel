...
public class Constants {
    ...
    public final static String JEDIS_DB="jedis.pool.db";
    public final static String JEDIS_TIMEOUT="jedis.pool.timeout";
    ...
    public final static String SPARK_SQL_TABlE_SCHEMA = "sparksql_table_schema";
